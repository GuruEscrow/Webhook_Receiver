...
import DataBase.EazypayoutsSanboxWebhookInsertToDB;

/**
 * Servlet implementation class ServletPractice
 */
@WebServlet("/eazypayoutsandbox/webhook")
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (jsonNode.has("payout_ref")) {
				...
				if (delay >= 3600) {
					EazypayoutsSanboxWebhookInsertToDB.insertPayoutRefToDelayTable(payout_ref,
				...
				EazypayoutsSanboxWebhookInsertToDB.insertDataToDB(payout_ref, payoutTime.format(outputFormatter),
